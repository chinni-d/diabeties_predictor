...
import { Heart, Brain, Shield, User, Award, Mail, ExternalLink, Globe } from "lucide-react"
          ...
          <CardContent className="p-6">
            <div className="flex flex-col lg:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center lg:text-left">
                <div className="mb-4">
                  <h3 className="text-2xl font-bold text-blue-600 mb-1">Manikanta Darapureddy</h3>
                  <div className="flex flex-wrap gap-2 justify-center lg:justify-start mb-4">
                    <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-200">AI/ML Engineer</Badge>
                    <Badge className="bg-green-100 text-green-800 hover:bg-green-200">Healthcare Technology</Badge>
                    <Badge className="bg-purple-100 text-purple-800 hover:bg-purple-200">Full Stack Development</Badge>
                  </div>
                </div>
                
                <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                I'm passionate about creating intelligent applications that are useful, user-friendly, and impactful. With experience in web development, AI and machine learning, I enjoy building smart systems that make life easier. This project reflects my commitment to combining cutting-edge tech with seamless design.
                </p>
